...
var groupify = function (value, field, record) {
	if (record.attributes.age >= 18)
		return record.attributes.country.substring(0,3).toUpperCase()+" "+record.attributes.gender.substring(0,1);
	else return "Underage";
};
...
var dataset = new recline.Model.Dataset({
    ...
    fields:[
        ...
        {id:'groupify', type:'string', deriver:groupify}
        ]
});
