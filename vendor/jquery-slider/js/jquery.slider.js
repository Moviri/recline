...
function (e) {
	...
	r.prototype.create = function () {
        ...
        // only fire event and change value if really changed 
        // (if step != 1 slider position may have change but actual value may still be the same) 
		if (this.inputNode.attr("value") != e)
		{
